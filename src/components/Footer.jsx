        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/mwamba-technologies-9626573b4/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 hover:bg-electric-cyan/20 border border-electric-cyan/20 hover:border-electric-cyan/40 rounded-lg flex items-center justify-center transition-all duration-300 group">
                <svg className="w-6 h-6 text-white/70 group-hover:text-electric-cyan transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#about" className="text-white/70 hover:text-electric-cyan transition-colors" onClick={(e) => {
                e.preventDefault();
              ...
              <li><a href="#services" className="text-white/70 hover:text-electric-cyan transition-colors" onClick={(e) => {
                e.preventDefault();
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-3">
                ...
                <a href="tel:+18142064451" className="text-white/70 hover:text-electric-cyan transition-colors">
                  +1 (814) 206-4451
                </a>
              </li>
              <li className="flex items-start space-x-3">
